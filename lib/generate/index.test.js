...
describe('generate', () => {
    ...
    test('Создаёт файл для элемента в папке блока', () => {
        ...
        expect(require('fs').__getMockFiles()['/block/__elem/block__elem.tsx']).toEqual(
            'block Block elem Elem block__elem',
        );
    });
    ...
    test('Создаёт файл для модификатора блока в папке блока', () => {
        ...
        expect(require('fs').__getMockFiles()['/block/_mod/block_mod_val.tsx']).toEqual(
    ...
    test('Создаёт файл для модификатора элемента в папке блока', () => {
        ...
        expect(require('fs').__getMockFiles()['/block/__elem/_mod/block__elem_mod_val.tsx']).toEqual(
    ...
    test('Правильно создаёт boolean модификатор', () => {
        ...
        expect(require('fs').__getMockFiles()['/block/__elem/_mod/block__elem_mod.tsx']).toEqual(
    ...
    test('Применяет конфиг нейминга', () => {
        ...
        expect(require('fs').__getMockFiles()['/block/::elem/:mod/block::elem:mod:val.tsx']).toEqual(
            'block Block elem Elem mod Mod val Val block::elem:mod:val',
        );
    });

    test('Создаёт вложенные папки', () => {
        fs = require('fs');
        ...
        expect(require('fs').__getMockFiles()['/block/block.hooks/use.ts']).toEqual('block Block block');
    });
});
