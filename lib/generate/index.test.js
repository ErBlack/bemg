...
describe('generate', () => {
    ...
    test('Skips item that does not start with delimiter', () => {
        fs.__setMockFiles({
            bemg,
            block: {},
        });
        ...
        expect(consoleErrorSpy).toHaveBeenCalledWith(
            'Skip "elem". Item should start with one of the delimiters: __, _, _',
        );
        expect(fs.__getMockFiles()['/block/blockelem.tsx']).toBeUndefined();
